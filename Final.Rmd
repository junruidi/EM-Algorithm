...
library(dplyr)
library(mvtnorm)
setwd("D:/Dropbox/Coursework/Optimization/HW/final/")
```
...
2. Main body of the EM. We have 65 parameters to estimate. 10 for means, and 55 for $\Sigma$. The actually formula for updating the parameters are based on Varadhan and Roland (2008)/ 
